...
const DICT = {
  en: {
    ...
    'lb.tab.today':   'Today',
    'lb.tab.movers':  'Biggest Movers',
    'lb.today.stats': 'Today: {n} scoring squads',
    'lb.today.empty': 'No matchday points yet.',
    'lb.movers.stats':'{n} biggest jumps',
    'lb.movers.empty':'No rank movement yet.',
  ...
  ar: {
    ...
    'lb.tab.today':   'اليوم',
    'lb.tab.movers':  'أكبر قفزات',
    'lb.today.stats': 'اليوم: {n} تشكيلات جمعت نقاط',
    'lb.today.empty': 'مفيش نقاط لليوم لسه.',
    'lb.movers.stats':'أكبر {n} قفزة',
    'lb.movers.empty':'مفيش حركة ترتيب لسه.',
