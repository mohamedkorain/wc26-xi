...
const DICT = {
  en: {
    ...
    'pts.red':        'Red card',
    'tx.title':       'Transfers',
    'tx.btn':         '🔄 Make MD3 transfers',
    'tx.wild.btn':    'Free wildcard swap',
    'tx.wild.title':  'Swap wildcard',
    'tx.wild.sub':    'Free before the MD3 deadline. Swap your wildcard with a starter of the same position. It does not use your 2 transfers.',
  ...
  ar: {
    ...
    'pts.red':        'كارت أحمر',
    'tx.title':       'الميركاتو',
    'tx.btn':         '🔄 اعمل تبديلات الجولة ٣',
    'tx.wild.btn':    'بدّل الورقة مجانًا',
    'tx.wild.title':  'تبديل الورقة الرابحة',
    'tx.wild.sub':    'مجاني قبل ديدلاين الجولة ٣. بدّل الورقة الرابحة مع أساسي في نفس المركز، ومش بيتحسب من التبديلين.',
    ...
    'tx.left':        'تبديلات الجولة ٣ المتبقية',
