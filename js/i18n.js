...
const DICT = {
  en: {
    ...
    'lb.mdpts.short': 'MD',
    'lb.mdpts.title': 'Current matchday points',
    ...
    'pts.red':        'Red card',
    'tx.title':       'Transfers',
    'tx.btn':         '🔄 Make a transfer',
    'tx.wild.btn':    'Free wildcard swap',
    'tx.wild.title':  'Swap wildcard',
    'tx.wild.sub':    'Free before MD2. Swap your wildcard with a starter of the same position. It does not use your 2 transfers.',
  ...
  ar: {
    ...
    'lb.mdpts.short': 'اليوم',
    'lb.mdpts.title': 'نقاط اليوم',
    ...
    'tx.wild.sub':    'مجاني قبل الجولة ٢. بدّل الورقة الرابحة مع أساسي في نفس المركز، ومش بيتحسب من التبديلين.',
