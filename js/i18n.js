...
const DICT = {
  ...
  ar: {
    ...
    'subin.hint':     'التشكيلة كملت — تقدر تبدّل ورقتك الحرة مع أساسي، وبعدين ابعت تحت.',
    ...
    'login.sub':      'هنبعتلك لينك دخول بضغطة واحدة. من غير باسورد.',
    'login.email':    'الإيميل',
    'login.placeholder':'you@example.com',
    'login.send':     '← ابعت اللينك',
    'login.or':       'أو',
    'login.guest':    '← دخول كضيف (تجريبي)',
    'login.sending':  'جاري الإرسال…',
    'login.sent':     'اتبعت! شوف إيميل {email} علشان تلاقي اللينك.',
