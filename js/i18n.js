...
const DICT = {
  en: {
    ...
    'heroes.title':   'Today’s Heroes',
    'heroes.sub':     'Players moving squads today',
    'heroes.empty':   'Today’s scoring leaders appear after matches are calculated.',
    'heroes.unavailable': 'Today’s scoring leaders are unavailable.',
    'heroes.squads':  '{n} squads',
    'market.title':   'Transfer Market',
    'market.sub':     'Current squad movement snapshot',
    'market.loading': 'Loading transfer market...',
    'market.used':    'Used transfers',
    'market.bundled': 'Used both',
    'market.untouched':'No transfers',
    'market.anomalies':'Needs review',
    'market.overlimit':'Over limit',
    'market.unavailable':'Transfer market snapshot is unavailable.',
  ...
  ar: {
    ...
    'heroes.title':   'نجوم اليوم',
    'heroes.sub':     'لاعبين حرّكوا تشكيلات النهاردة',
    'heroes.empty':   'نجوم اليوم هيظهروا بعد حساب نقاط الماتشات.',
    'heroes.unavailable': 'نجوم اليوم مش متاحين دلوقتي.',
    'heroes.squads':  '{n} تشكيل',
    'market.title':   'الميركاتو',
    'market.sub':     'ملخص حركة التبديلات الحالية',
    'market.loading': 'تحميل الميركاتو...',
    'market.used':    'استخدموا تبديلات',
    'market.bundled': 'استخدموا الاتنين',
    'market.untouched':'بدون تبديلات',
    'market.anomalies':'للمراجعة',
    'market.overlimit':'فوق الحد',
    'market.unavailable':'ملخص الميركاتو مش متاح دلوقتي.',
