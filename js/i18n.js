...
const DICT = {
  en: {
    ...
    'score.status.window': '11:00-12:50 Dubai',
    ...
    'score.status.updated': 'Last updated: {match} · {time} Dubai.',
  ...
  ar: {
    ...
    'score.status.window': '١١:٠٠-١٢:٥٠ بتوقيت دبي',
    ...
    'score.status.updated': 'آخر تحديث: {match} · {time} دبي.',
